...
document.getElementById('controlRewind').onclick = () => {
  startTimelineRewind();
};
...
// initial state
loopPlaybackCheck.textContent = '';

loopPlayback.addEventListener('click', e => {
  e.stopPropagation();

  if (loopPlaybackEnabled === true) {
    // hide
    loopPlaybackEnabled = false;
    loopPlaybackCheck.style.visibility = 'hidden';
    loopPlaybackCheck.textContent = '';
  } else {
    // show
    loopPlaybackEnabled = true;
    loopPlaybackCheck.textContent = '✓';
    loopPlaybackCheck.style.visibility = 'visible';
  }
});
